(function (global, factory) {
	...
	function getTargetValue(target, _value) {
	  ...
	  if (isCallable(_value) && !isBoundedFunction(_value) && !isConstructable(_value)) {
	    ...
	    var boundValue = Function.prototype.bind.call(_value, target); // some callable function has custom fields, we need to copy the enumerable props to boundValue. such as moment function.
	...
	var ProxySandbox = /*#__PURE__*/function () {
	  ...
	  _createClass(ProxySandbox, [{
	    ...
	    value:
	    /** window 值变更记录 */
	    function registerRunningApp(name, proxy) {
	      if (this.sandboxRunning) {
